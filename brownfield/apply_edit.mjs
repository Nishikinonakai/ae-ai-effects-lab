...
// saveFrameToPng is ASYNC — the ExtendScript returns before the PNG finishes writing. Settle rule
// shared with verify_edit's temporal sampling: brownfield/frame_settle.mjs (KillKiss finding #3).
